...
Stick input is shaped through the same expo curve as the pure-torque
strategy before scaling to Nm and rev/s respectively.
"""
...
class TracksMixedStrategy(ConversionStrategy):
    """Per side: node_ids[:-1] → velocity governor, node_ids[-1] → torque output."""
