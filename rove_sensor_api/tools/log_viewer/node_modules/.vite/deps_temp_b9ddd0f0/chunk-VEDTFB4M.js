  ...
  function(_super) {
    ...
    function MultiSelect2() {
      ...
      _this.renderQueryList = function(listProps) {
        ...
        return React2.createElement(Popover, __assign({ autoFocus: false, canEscapeKeyClose: true, disabled, enforceFocus: false, isOpen: _this.state.isOpen, placement: popoverProps.position || popoverProps.placement ? void 0 : "bottom-start" }, popoverProps, { className: (0, import_classnames.default)(listProps.className, popoverProps.className), content: React2.createElement(
          "div",
          __assign({
          ...
          _this.props.customTarget != null && _this.getTagInput(listProps, (0, import_classnames.default)(classes_exports.FILL, classes_exports2.MULTISELECT_POPOVER_TAG_INPUT_MARGIN)),
          listProps.itemList
      ...
      _this.getTagInput = function(listProps, className) {
        ...
        var maybeClearButton = onClear !== void 0 && selectedItems.length > 0 ? (
          ...
          React2.createElement(Button, { "aria-label": "Clear selected items", disabled, icon: React2.createElement(Cross, null), onClick: _this.handleClearButtonClick, title: "Clear selected items", variant: "minimal" })
        ) : void 0;
        var inputProps = __assign(__assign({}, tagInputProps.inputProps), { className: (0, import_classnames.default)((_a2 = tagInputProps.inputProps) === null || _a2 === void 0 ? void 0 : _a2.className, classes_exports2.MULTISELECT_TAG_INPUT_INPUT) });
        return React2.createElement(TagInput, __assign({ placeholder, rightElement: maybeClearButton }, tagInputProps, { className: (0, import_classnames.default)(className, classes_exports2.MULTISELECT, tagInputProps.className), disabled, fill, inputRef: _this.refHandlers.input, inputProps, inputValue: listProps.query, onAdd: _this.getTagInputAddHandler(listProps), onInputChange: listProps.handleQueryChange, onRemove: _this.handleTagRemove, values: selectedItems.map(_this.props.tagRenderer) }));
      };
      ...
      _this.renderQueryList = function(listProps) {
        ...
        return React3.createElement(
          ...
          React3.createElement(
            ...
            React3.createElement(InputGroup, __assign({ autoFocus: true, leftIcon: React3.createElement(Search, null), placeholder: "Search...", size: "large" }, inputProps, { onChange: listProps.handleQueryChange, value: listProps.query })),
            listProps.itemList
          )
        );
      };
  ...
  function(_super) {
    ...
    function Select2() {
      ...
      _this.renderQueryList = function(listProps) {
        ...
        var input = React4.createElement(InputGroup, __assign({ "aria-autocomplete": "list", leftIcon: React4.createElement(Search, null), placeholder, rightElement: _this.maybeRenderClearButton(listProps.query) }, inputProps, { inputRef: _this.handleInputRef, onChange: listProps.handleQueryChange, value: listProps.query }));
        var handleKeyDown = listProps.handleKeyDown, handleKeyUp = listProps.handleKeyUp;
    ...
    Select2.prototype.maybeRenderClearButton = function(query) {
      return query.length > 0 ? React4.createElement(Button, { "aria-label": "Clear filter query", icon: React4.createElement(Cross, null), onClick: this.resetQuery, title: "Clear filter query", variant: "minimal" }) : void 0;
    };
...
export {
  classes_exports2 as classes_exports,
  renderFilteredItems,
  executeItemsEqual,
  getCreateNewItem,
  isCreateNewItem,
...
//# sourceMappingURL=chunk-VEDTFB4M.js.map
